...
<div class="form-body">
    ...
    <div class="tab-content">
        ...
        <div class="innter-form">
            <form class="sa-innate-form" action="${basePath}/Customer/login.do" id="login-form" method="post" onsubmit="return checkForm()">
            <label>用户名</label>
         ...
         <div id="sectionB" class="tab-pane fade">
			<div class="innter-form">
            <form class="sa-innate-form" method="post" id="register-form" action="${basePath}/Customer/register.do">
            <label>用户名</label>
            ...
            <p style="display: inline-block;">点击开始剁手之旅吧！</p>
            </form>
            </div>
        </div>
          </div>
